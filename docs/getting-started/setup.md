...
You don’t need to download Now Prototype It manually. Instead, when you [create a prototype](/latest/getting-started/try-demo-prototype), you run a single command that temporarily downloads it, creates a prototype on your machine, and then discards the download. This saves space, and ensures you’re always using the latest version.
